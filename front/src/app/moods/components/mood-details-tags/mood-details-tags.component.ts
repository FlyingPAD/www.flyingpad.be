...
@Component({
  selector: 'app-mood-details-tags',
  templateUrl: './mood-details-tags.component.html',
  styleUrl: './mood-details-tags.component.scss'
})
export class MoodDetailsTagsComponent implements OnDestroy
{
