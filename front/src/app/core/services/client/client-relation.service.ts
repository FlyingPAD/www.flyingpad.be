...
import { CheckRelationsArtistStyleByArtistResponse, CheckRelationsArtistStyleByStyleResponse, CreateRelationsArtistStyleResponse, RelationsArtistStyleForm } from '../../models/relations';
...
export class RelationService 
{
  ...
  public InsertRMT( moodId : number, tags : number[] )
  {
    return this.#http.post(this.url + 'Relation/MT?mood_id=' + moodId, tags)
  }
