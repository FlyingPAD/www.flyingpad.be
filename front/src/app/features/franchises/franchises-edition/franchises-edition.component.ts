...
@Component({
  selector: 'app-franchises-edition',
  templateUrl: './franchises-edition.component.html',
  styleUrl: './franchises-edition.component.scss'
})
export class FranchisesEditionComponent 
{
