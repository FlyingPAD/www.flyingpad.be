...
public class ModelRepository(Context context) : BaseRepository<Model>(context), IModelRepository
{
    ...
    public async Task UpdateFranchises(int modelId, ICollection<int> franchiseIds)
    {
    ...
    public async Task AddFranchisesAsync(int modelId, IEnumerable<int> franchisesIds)
    {
    ...
    public async Task RemoveFranchisesAsync(Model model)
    {
